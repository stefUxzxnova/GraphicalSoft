...
namespace Draw
{
    ...
    public class DialogProcessor : DisplayProcessor
    {
        ...
        //Метод, който използваме за динамичните форми
        ...
        //Метод за добавяне на форма към листа
        ...
        //Пренаписваме draw метода (очертания на селектираните елементи)
        ...
        //Метод за селектиране на всички форми
            ...
            if (CopiedElements.Count > 0)
            {
                ...
                foreach (Shape item in CopiedElements)
                {
                    ...
                    else if (type.Equals("Triangle"))
                    {
                        ...
                        triangle.Name = item.Name;

                        ShapeList.Add(triangle);
                        Selection.Add(triangle);
                    }
                    else if (type.Equals("CustomShape"))
                    {
                        CustomShape shape = new CustomShape(new RectangleF(item.Rectangle.X + 40, item.Rectangle.Y + 40, item.Rectangle.Width, item.Rectangle.Height));
                        shape.FillColor = item.FillColor;
                        shape.StrokeColor = item.StrokeColor;
                        shape.ContourWidth = item.ContourWidth;
                        shape.ShapeAngle = item.ShapeAngle;
                        shape.TransformationMatrix = item.TransformationMatrix;
        ...
        //Метод за именуване на примитиви
        ...
        //Метод, който рисува CustomShape
        ...
        public void AddCustomShape()
        {
            ...
            CustomShape customShape = new CustomShape(new Rectangle(x, y, 200, 100));
            customShape.FillColor = Color.White;
