	...
	public partial class MainForm : Form
    {
        ...
        void ViewPortMouseDown(object sender, System.Windows.Forms.MouseEventArgs e)
        {
            ...
            if (AddCustomRectangleToolStripButton2.Checked)
            {
                ...
                AddCustomElipse.Checked = false;
                AddCustomShapeCustom.Checked = false;
                dialogProcessor.IsDragging = true;
            ...
            if (AddCustomShapeCustom.Checked)
            {
                dialogProcessor.IsDragging = true;
                //start point -> точката, в която е натисната мишката
                startPoint = e.Location;
                shape = new CustomShape(new RectangleF(startPoint.X, startPoint.Y, startPoint.X, startPoint.Y));
                shape.FillColor = Color.White;
                dialogProcessor.AddToShapeList(shape);
                BuildTreeView();
            }
        ...
        void ViewPortMouseMove(object sender, System.Windows.Forms.MouseEventArgs e)
        {
            ...
            if (AddCustomShapeCustom.Checked && dialogProcessor.IsDragging == true)
            {
                //докато мишката се движи, lastPoint се променя
                lastPoint = e.Location;
                dialogProcessor.ManageCustomRectangle(shape, startPoint, lastPoint);
        ...
        private void contextMenuStrip1_Opening(object sender, System.ComponentModel.CancelEventArgs e)
        {
            ...
            else
            {
                ...
                "New CustomShape",
                null,
                new EventHandler(this.AddCustomShape_Click));
        ...
        {
            dialogProcessor.AddCustomShape();
            statusBar.Items[0].Text = "Последно действие: Рисуване на custom форма.";
            BuildTreeView();
            viewPort.Invalidate();
        }
    }
